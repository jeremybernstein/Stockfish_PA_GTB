...
void init_uci_options() {
  ...
  Options["ProbeOnlyAtRoot"] = Option(true);
  ...
  Options["Preserve Analysis"] = Option(true);
...
Option::Option(string def, StrVector values) : type("combo"), idx(Options.size()), defaultValue(def), currentValue(def), comboValues(values), minValue(0), maxValue(0) {}
